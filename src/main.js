...
render(siteMainElement, createFlimListTemplate(), `beforeend`);


render(siteMainElement, createButtonShowTemplate(), `beforeend`);
render(siteMainElement, createTopRatedTemplate(), `beforeend`);
render(siteMainElement, createTopCommentTemplate(), `beforeend`);
